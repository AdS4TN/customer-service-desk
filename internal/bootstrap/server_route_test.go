...
func TestNewServerRegistersGinRoutes(t *testing.T) {
	...
	expected := []string{
		...
		http.MethodPost + " /api/dashboard/conversation/:id/translate_message",
		http.MethodPost + " /api/dashboard/conversation/:id/translate_text",
		http.MethodGet + " /api/dashboard/conversation/sales_leads",
		http.MethodGet + " /api/dashboard/conversation/sales_leads/:leadId",
		http.MethodPost + " /api/dashboard/conversation/sales_leads/:leadId/update",
		...
		http.MethodPost + " /api/dashboard/knowledge-retrieve/preview",
		http.MethodGet + " /api/dashboard/knowledge-document/:id/index_status",
